...
import { WhatsAppWebBot } from "@/components/patient/WhatsAppWebBot";
...
export const WhatsAppChatbot = () => {
  ...
  const openActualWhatsApp = () => {
    ...
    const url = cleanNumber 
      ? `https://web.whatsapp.com/send?phone=${cleanNumber}&text=${defaultText}`
      : `https://web.whatsapp.com/send?text=${defaultText}`;
    
    window.open(url, "_blank");
    toast.success("Opening WhatsApp Web with MediNexus AI Bot payload!");
  };

  return (
    <div className="space-y-6">
      {/* Real WhatsApp Web Integration & Auto Bot Controller */}
      <WhatsAppWebBot />
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription className="text-xs">
                  Interactive WhatsApp chat interface showing double checks ✔✔, quick replies, and instant AI bot responses
                </CardDescription>
              </div>
            </div>
          </div>
